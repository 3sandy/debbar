...
public class CreatNewContactPage extends webDriverUtility
{
	//Declaration
...
//Utilization
	 ...
	 */
	public void creatNewContact(String lastname,String leadSourceType)
	{
		ContactNameEdt.sendKeys(lastname);
	 ...
	 * @param driver
	 */
	public void creatNewContact(String lastname,String orgName,WebDriver driver)
	{
		ContactNameEdt.sendKeys(lastname);
		OrgLookUpImg.click();
